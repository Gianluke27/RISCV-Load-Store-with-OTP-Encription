...
#
# Generated by export_simulation on Sun Oct 15 22:14:15 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './RISCV_bd.sh' script.

./RISCV_bd.sh -reset_run
...
./RISCV_bd.sh -noclean_files

For more information on the script, please type './RISCV_bd.sh -help'.
