...
HD_PWD='H:/TesiMagistrale/Github/RISCV_Enc_Load_Store/RISCV-Load-Store-with-OTP-Encription/RISCV_project/RISCV_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_demonstrator_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISCV_demonstrator_wrapper.tcl -notrace
