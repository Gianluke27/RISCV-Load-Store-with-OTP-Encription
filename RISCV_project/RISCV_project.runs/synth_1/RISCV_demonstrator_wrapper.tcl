...
namespace eval ::optrace {
  variable script "H:/TesiMagistrale/Github/RISCV_Enc_Load_Store/RISCV-Load-Store-with-OTP-Encription/RISCV_project/RISCV_project.runs/synth_1/RISCV_demonstrator_wrapper.tcl"
...
set_property used_in_implementation false [get_files -all h:/TesiMagistrale/Github/RISCV_Enc_Load_Store/RISCV-Load-Store-with-OTP-Encription/RISCV_project/RISCV_project.gen/sources_1/bd/RISCV_demonstrator/ip/RISCV_demonstrator_auto_pc_0/RISCV_demonstrator_auto_pc_0_ooc.xdc]
...
synth_design -top RISCV_demonstrator_wrapper -part xc7z020clg400-1
...
write_checkpoint -force -noxdef RISCV_demonstrator_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file RISCV_demonstrator_wrapper_utilization_synth.rpt -pb RISCV_demonstrator_wrapper_utilization_synth.pb"
