...
HD_PWD='H:/TesiMagistrale/Github/RISCV_Enc_Load_Store/RISCV-Load-Store-with-OTP-Encription/RISCV_project/RISCV_project.runs/RISCV_demonstrator_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_demonstrator_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISCV_demonstrator_processing_system7_0_0.tcl
